...
def process_single_feature_set(feature_folder, train_ds, test_ds):
    ...
    # Split interno para o Early Stopping (20% para validação)
    ...
    # Conversão das predições textuais originais para o formato binário estruturado (0 e 1)
...
def run_pipeline():
    ...
    if test_ids is not None:
        ...
        # Nome do arquivo de saída configurado com o sufixo _CB
