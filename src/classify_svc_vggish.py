...
# Mantida a última feature alvo analisada (ajuste se necessário)
...
def objective(trial, X_train, y_train):
    ...
    # Se o kernel for polinomial, podemos sugerir o grau (degree)
    ...
    # O SVC nativo do scikit-learn não possui n_jobs interno, por isso o paralelismo é feito no cross_val_score.
...
def run_pipeline():
    ...
    if test_ids is not None:
        ...
        # Atualizado o nome do arquivo de saída para refletir o uso do SVC
