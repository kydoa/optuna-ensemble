...
FEATURE_TARGET = 'ComParE_2016_6k'
...
def objective(trial, X_train, y_train):
    ...
    param = {
        ...
        'thread_count': -1  # Uso total de threads para acelerar o processamento individual
    }
...
def process_single_feature_set(feature_folder, train_ds, test_ds):
    ...
    # Split interno para controle do Early Stopping (20% para validação)
    ...
    # Treinamento final associando o conjunto de validação ao early stopping de 20 rodadas
    ...
    # Conversão das predições para o padrão binário estruturado (0 e 1)
