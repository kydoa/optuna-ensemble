...
# Define aqui a feature alvo para o teste individual (ex: vggish, trill, Lexical_Full, etc.)
...
def objective(trial, X_train, y_train):
    ...
    param = {
        ...
        'thread_count': -1  # Usa todas as threads disponíveis para acelerar a tunagem individual
    }
...
def process_single_feature_set(feature_folder, train_ds, test_ds):
    """Trata dados, treina via Optuna e infere predições no conjunto de teste."""
    ...
    # Split interno para controle do Early Stopping
    ...
    # Treinamento final com Early Stopping associado ao split de validação
    ...
    # Conversão das saídas textuais em binárias estruturadas (0 para HC, 1 para AD)
...
def run_pipeline():
    ...
    if test_ids is not None:
        ...
        # Nome do arquivo final atualizado com o sufixo _CB
