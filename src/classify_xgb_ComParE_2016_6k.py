...
# Mantida a última feature analisada (ajuste conforme necessário)
...
def objective(trial, X_train, y_train_encoded):
    ...
    # Calcula a proporção baseada nas classes codificadas (0: HC, 1: AD)
...
def process_single_feature_set(feature_folder, train_ds, test_ds):
    ...
    # Passamos os rótulos devidamente codificados em inteiros (0 e 1) para a otimização
